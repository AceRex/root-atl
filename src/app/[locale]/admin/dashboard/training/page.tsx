      ...
      <div className="grid grid-cols-4 gap-5 my-2">
        <div className="col-span-1 p-6 flex flex-col gap-4 border border-neutral-200 bg-white rounded-lg">
          ...
          <div className="flex items-center">
            <h2 className="text-3xl font-semibold mt-2">1200</h2>
          </div>
        </div>
        <div className="col-span-1 p-6 flex flex-col gap-4 border border-neutral-200 bg-white rounded-lg">
          <p className="text-base text-[#B69B64] font-semibold">
          ...
          <div className="flex items-center">
            <h2 className="text-3xl font-semibold mt-2">120</h2>
          </div>
        </div>
        <div className="col-span-1 p-6 flex flex-col gap-4 border border-neutral-200 bg-white rounded-lg">
          <p className="text-base text-[#B69B64] font-semibold">Videos</p>
          <div className="flex items-center">
            <h2 className="text-3xl font-semibold mt-2">20</h2>
          </div>
        </div>
        <div className="col-span-1 p-6 flex flex-col gap-4 border border-neutral-200 bg-white rounded-lg">
          <p className="text-base text-[#B69B64] font-semibold">Documents</p>
          <div className="flex items-center">
